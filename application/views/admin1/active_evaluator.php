...
<div class="row">
	<div class="col-md-2">
        ...
        <input type="text" name="question_no" class="form-control" value="<?= ((isset($question['question_no'])) ? $question['question_no'] : "") ?>" placeholder="First Name">
	</div>
	<div class="col-md-2">
		<label><strong>Last Name</strong></label>
        <input type="text" name="question_no" class="form-control" value="<?= ((isset($question['question_no'])) ? $question['question_no'] : "") ?>" placeholder="Last Name">
	</div>
	<div class="col-md-4">
		<label><strong>My Info</strong></label>
        <textarea style="height: 80px;" class="form-control" name="Question" placeholder="Info" required><?= ((isset($question['Question'])) ? $question['Question'] : "") ?></textarea>
	</div>
	<div class="col-md-2">
		<label><strong>Nick Name</strong></label>
        <input type="text" name="question_no" class="form-control" value="<?= ((isset($question['question_no'])) ? $question['question_no'] : "") ?>" placeholder="Nick Name">
	</div>
	<div class="col-md-2">
		<label><strong>Phone Number</strong></label>
        <input type="number" name="question_no" class="form-control" value="<?= ((isset($question['question_no'])) ? $question['question_no'] : "") ?>" placeholder="Mobile Number">
	</div>
	<div class="col-md-2">
        ...
        <!-- <?=form_dropdown('usercategory', array(
            ...
            "Silver" => 'Silver',
            "Gold" => 'Gold',
            ), (($question['usercategory'])?$question['usercategory']:set_value('usercategory')), 'class="form-control" required')
        ?> -->
    </div>
    <div class="col-md-3">
		<label><strong>Email</strong></label>
        <input type="email" name="question_no" class="form-control" value="<?= ((isset($question['question_no'])) ? $question['question_no'] : "") ?>" placeholder="Email">
	</div>
	<div class="col-md-4">
		<label><strong>Verifie User</strong></label><br>
		<input type="radio" name="" class=""> Active
		<input type="radio" name="" class=""> DeActive
	</div>
</div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?= anchor('admin/evaluator_data', '<input type="button" value="Cancel" class="btn btn-primary">') ?>
    </div>
</div>
<?= form_close() ?>
